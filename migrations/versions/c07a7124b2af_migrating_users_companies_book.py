"""Migrating users,companies,book

Revision ID: c07a7124b2af
Revises: 
Create Date: 2025-03-08 22:01:53.384925
...
def upgrade():
    ...
    sa.Column('biography', sa.Text(length=50), nullable=False),
